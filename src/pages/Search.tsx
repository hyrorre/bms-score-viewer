...
const Search: Component = () => {
  const columnDefs = [
    ...
    { field: 'bpm', suppressMovable: true, headerName: 'BPM', minWidth: 75, maxWidth: 75 },
    { field: 'notes', suppressMovable: true, minWidth: 75, maxWidth: 75 },
    { field: 'date', suppressMovable: true, headerName: 'Added date', minWidth: 200, maxWidth: 250, valueFormatter: (e: any) => new Date(e.value).toUTCString() },
    { field: 'md5', suppressMovable: true, headerName: 'LR2IR', minWidth: 75, maxWidth: 75, cellRenderer: (e: any) => (<ButtonUrl href={`http://www.dream-pro.info/~lavalse/LR2IR/search.cgi?mode=ranking&bmsmd5=${e.value}`} text={"LR2IR"} />)}
  ];
